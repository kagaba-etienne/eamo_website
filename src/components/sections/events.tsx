...
const Events = () => {
  return (
    <section id="events">
      <div className="head text-5xl font-semibold text-center text-forest_green">Events</div>
        ...
        <div className="events flex flex-col gap-5 items-center max-w-4xl mx-auto">
          <div className="event_card rounded-sm">
            <div className="caption text-center p-3">
              ...
              <div className="date py-2 text-ucla_blue/80">Date: Depends on the country</div>
              <div className="pt-2">
          ...
          <div className="event_card rounded-sm">
            <div className="caption text-center p-3">
              ...
              <div className="date py-2 text-ucla_blue/80">Date: March 15th</div>
              <div className="pt-2">
          ...
          <div className="event_card rounded-sm">
            <div className="caption text-center p-3">
              <div className="text-lg py-2 font-semibold text-ucla_blue">Competition Week</div>
              <div className="date py-2 text-ucla_blue/80">Date: April 20th</div>
              <div className="pt-2">
                ...
                the students&apos; mathematical knowledge. Winners are announced at
                the end of the week, with ceremonies to award the top performers
                for their excellence and hard work. This not only celebrates
                their achievements but also inspires a spirit of mathematical
                pursuit among all participants.
              </div>
            </div>
          </div>
        </div>
